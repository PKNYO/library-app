class Book {
    ...
    addBookToLibrary(newBook) {
        ...
        this.createBookCard(newBook.name, newBook.author, newBook.pages, newBook.read);
        this.updateLibrary()
    }
    
    createBookCard(name, author, pages, read) {
        ...
        deleteButton.addEventListener("click", (e) => this.deleteCard(e));
        readButton.addEventListener("click", (e) => {this.isRead(e)});
    }
